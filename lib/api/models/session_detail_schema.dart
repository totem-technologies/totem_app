...
part 'session_detail_schema.g.dart';

@JsonSerializable()
class SessionDetailSchema {
  ...
  factory SessionDetailSchema.fromJson(Map<String, Object?> json) =>
      _$SessionDetailSchemaFromJson(json);
  ...
  Map<String, Object?> toJson() => _$SessionDetailSchemaToJson(this);
}
