  ...
  Future<MobileSpaceDetailSchema> totemCirclesMobileApiMobileApiGetSpaceDetail({
    ...
    final _options = _setStreamType<MobileSpaceDetailSchema>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/protected/spaces/space/${spaceSlug}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<EventDetailSchema> totemCirclesMobileApiMobileApiGetSessionDetail({
    ...
    final _options = _setStreamType<EventDetailSchema>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/protected/spaces/session/${eventSlug}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<void> totemCirclesMobileApiMobileApiPostSessionFeedback({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/protected/spaces/session/${eventSlug}/feedback',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  totemCirclesMobileApiMobileApiGetRecommendedSpaces({
    ...
    final _options = _setStreamType<List<EventDetailSchema>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/protected/spaces/sessions/recommended',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<EventDetailSchema> totemCirclesMobileApiMobileApiRsvpConfirm({
    ...
    final _options = _setStreamType<EventDetailSchema>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/protected/spaces/rsvp/${eventSlug}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
