...
Future<void> _pumpRoomScreenForResolvedScreen(
  ...
  final sessionState = SessionRoomState(
    ...
    participants: ParticipantsState(participants: [p1, p2, keeper]),
...
void main() {
  ...
  group('VideoRoomScreen - audio route notification', () {
    late MockSessionController session;
    late MockSessionDeviceController devices;
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await _pumpRoomScreenWithMutableState(
          ...
          roomStatus: RoomStatus.active,
          extraOverrides: [
            isOfflineProvider.overrideWith((ref) => connectivityChanges.stream),
          ],
  ...
  group('VideoRoomScreen - keeper disconnect notification lifecycle', () {
